...
(function ($) {
    ...
    function dispatchTimer() {
        timer = {
            total: Math.floor((settings.start - settings.now) / 86400000),
            days: Math.floor((settings.now - settings.start ) / 86400000),
            hours: Math.floor(((settings.now - settings.start) % 86400000) / 3600000),
            minutes: Math.floor((((settings.now - settings.start) % 86400000) % 3600000) / 60000),
            seconds: Math.floor((((settings.now - settings.start) % 86400000) % 3600000) % 60000 )
        }
    }
